...
// Outras Definições ---------------------------------------------------------------------------------------------------------------------------------
 ...
 #define NAR              250             //Número de amostragens para a média móvel da leitura do LDR do RADIO
...
void ESTADOzello()
{
  ...
  {
    if ((millis() - TimerDeEntrada) > 5)                         //Aguardar a leitura se estabilizar por este tempo
    {

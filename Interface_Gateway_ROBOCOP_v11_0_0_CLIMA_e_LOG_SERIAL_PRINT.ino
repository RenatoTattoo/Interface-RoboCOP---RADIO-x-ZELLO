...
// Variáveis, arrays, funções, etc--------------------------------------------------------------------------------------------------------------------
 ...
 const String  CityID            = "1234567";                          // id da cidade no OpenWeather 
 const String  APIKEY            = "abcdefgh123456789abcdefgh1234567"; // API Código de acesso a informações de clima OpenWeather
 char          servername[]      = "api.openweathermap.org";           // Nome do servidor de dados do clima
 const char    CIDADE[]          = "CIDADE";       // Coloque o NOME ou ABREVIAÇÃO de sua cidade com no MAXIMO 6 LETRAS
